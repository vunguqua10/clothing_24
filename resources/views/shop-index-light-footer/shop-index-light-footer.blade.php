...
<body class="ecommerce">
    ...
    <div class="color-panel hidden-sm">
      ...
      <div class="header">
        <div class="container">
          <a class="site-logo" href="shop-index.html"><img src="{{ asset('/corporate/img/logos/logo-shop-red.png')}}" alt="Metronic Shop UI"></a>
                    ...
                    <div class="header-navigation-content">
                      <div class="row">
                        <div class="col-md-3 col-sm-4 col-xs-6">
                          <div class="product-item">
                            <div class="pi-img-wrapper">
                              <a href="shop-item.html"><img src="{{ asset('/pages/img/products/model4.jpg')}}" class="img-responsive" alt="Berry Lace Dress"></a>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-6">
                          <div class="product-item">
                            <div class="pi-img-wrapper">
                              <a href="shop-item.html"><img src="{{ asset('/pages/img/products/model3.jpg')}}" class="img-responsive" alt="Berry Lace Dress"></a>
                            </div>
                            <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                            <div class="pi-price">$29.00</div>
                            <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-6">
                          <div class="product-item">
                            <div class="pi-img-wrapper">
                              <a href="shop-item.html"><img src="{{ asset('/pages/img/products/model7.jpg')}}" class="img-responsive" alt="Berry Lace Dress"></a>
                            </div>
                            <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                            <div class="pi-price">$29.00</div>
                            <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
          ...
          <div class="col-md-12 sale-product">
            ...
            <div class="owl-carousel owl-carousel5">
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/model1')}}.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/model1')}}.jpg" class="btn btn-default fancybox-button">Zoom</a>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/model2')}}.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/model2')}}.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/model6')}}.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/model6')}}.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Berry Lace Dress2</a></h3>
              ...
              <div>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="{{ asset('/pages/img/products/model4')}}.jpg" class="img-responsive" alt="Berry Lace Dress">
                      <div>
                        <a href="{{ asset('/pages/img/products/model4')}}.jpg" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                      </div>
                    </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/model5')}}.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/model5')}}.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/model3')}}.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/model3')}}.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/model7')}}.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/model7')}}.jpg" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Berry Lace Dress3</a></h3>
          ...
          <div class="col-md-9 col-sm-8">
            ...
            <div class="owl-carousel owl-carousel3">
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    ...
                    <div>
                      <a href="{{ asset('/pages/img/products/k1.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    ...
                    <div>
                      <a href="{{ asset('/pages/img/products/k2.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Berry Lace Dress2</a></h3>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/k3.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/k3.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Berry Lace Dress3</a></h3>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/k4.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/k4.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="item active">
                      <img src="{{ asset('/pages/img/index-sliders/slide1.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    </div>
                    <div class="item">
                      <img src="{{ asset('/pages/img/index-sliders/slide2.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    </div>
                    <div class="item">
                      <img src="{{ asset('/pages/img/index-sliders/slide3.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    </div>
                  </div>
                </div>
              </div>
