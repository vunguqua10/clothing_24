...
<head>
  ...
  <!-- Global styles START -->
  <link href="{{ asset('/plugins/font-awesome/css/font-awesome.min.cs')}}" rel="stylesheet">
...
<body class="ecommerce">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-phone"></i><span>+84 979732835</span></li>
                        <!-- BEGIN CURRENCIES -->
                        ...
                        <li class="langs-block">
                            ...
                            <div class="langs-block-others-wrapper"><div class="langs-block-others">
                              <a href="javascript:void(0);">Đức</a>
                              <a href="javascript:void(0);">Pháp</a>
                              <a href="javascript:void(0);">Việt Nam</a>
                            </div></div>
                        </li>
                        <!-- END LANGS -->
                    </ul>
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="shop-index.html">SIX MEN POLO</a>
          ...
          <div class="top-cart-content-wrapper">
            <div class="top-cart-content">
              <ul class="scroller" style="height: 250px;">
                <li>
                  <a href="shop-item.html"><img src="{{asset('/pages/img/cart-img.jpg')}}" alt="Rolex Classic Watch" width="37" height="34"></a>
        ...
        <div class="header-navigation">
          <ul>
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      ...
                      <div class="col-md-12 nav-brands">
                        <ul>
                          <li><a href="shop-product-list.html"><img title="esprit" alt="esprit" src="{{ asset('/pages/img/brands/esprit.jpg')}}"></a></li>
                          <li><a href="shop-product-list.html"><img title="gap" alt="gap" src="{{ asset('/pages/img/brands/gap.jpg')}}"></a></li>
                          <li><a href="shop-product-list.html"><img title="next" alt="next" src="{{ asset('/pages/img/brands/next.jpg')}}"></a></li>
                          <li><a href="shop-product-list.html"><img title="puma" alt="puma" src="{{ asset('/pages/img/brands/puma.jpg')}}"></a></li>
                          <li><a href="shop-product-list.html"><img title="zara" alt="zara" src="{{ asset('/pages/img/brands/zara.jpg')}}"></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
            ...
            <li><a href="shop-item.html">Trẻ em</a></li>
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="{{ asset('/pages/img/products/pl1.jpg')}}" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="{{ asset('/pages/img/products/pl2.jpg')}}" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="{{ asset('/pages/img/products/pl3.jpg')}}" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="{{ asset('/pages/img/products/pl4.jpg')}}" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                    ...
                    <div class="container">
                        <div class="carousel-position-four text-center">
                            <h2 class="margin-bottom-20 animate-delay carousel-title-v3 border-bottom-title text-uppercase" data-animation="animated fadeInDown">
                                Tones of <br/><span class="color-red-v2">SIX MEN</span><br/> designed
                            </h2>
          ...
          <div class="col-md-12 sale-product">
            ...
            <div class="owl-carousel owl-carousel5">
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/pl1.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/pl1.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Quần áo  </a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/pl2.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/pl2.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Quần áo 2</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/pl3.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/pl3.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Quần áo 3</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>
              <div>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="{{ asset('/pages/img/products/pl4.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                      <div>
                        <a href="{{ asset('/pages/img/products/pl4.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                      </div>
                    </div>
                    <h3><a href="javascript:;">Quần áo 4</a></h3>
                    <div class="pi-price">$29.00</div>
                    <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
              ...
              <div>
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.html">Quần áo 5</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>
        ...
        <div class="row margin-bottom-40 ">
          ...
          <div class="sidebar col-md-3 col-sm-4">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              <li class="list-group-item clearfix"><a href="shop-product-list.html"><i class="fa fa-angle-right"></i> Nữ</a></li>
              ...
              <li class="list-group-item clearfix"><a href="shop-product-list.html"><i class="fa fa-angle-right"></i> Trẻ em</a></li>
              <li class="list-group-item clearfix"><a href="shop-product-list.html"><i class="fa fa-angle-right"></i> Phụ kiện</a></li>
              <li class="list-group-item clearfix"><a href="shop-product-list.html"><i class="fa fa-angle-right"></i> Thể thao</a></li>
              <li class="list-group-item clearfix"><a href="shop-product-list.html"><i class="fa fa-angle-right"></i> Nhãn hiệu</a></li>
              <li class="list-group-item clearfix"><a href="shop-product-list.html"><i class="fa fa-angle-right"></i> Điện tử</a></li>
            </ul>
          </div>
          <!-- END SIDEBAR -->
          <!-- BEGIN CONTENT -->
          <div class="col-md-9 col-sm-8">
            ...
            <div class="owl-carousel owl-carousel3">
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/ps1.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/ps1.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Quần áo </a></h3>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/ps2.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/ps2.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Quần áo 2</a></h3>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/ps3.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/ps3.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Quần áo 3</a></h3>
              ...
              <div>
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="{{ asset('/pages/img/products/ps4.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                    <div>
                      <a href="{{ asset('/pages/img/products/ps4.jpg')}}" class="btn btn-default fancybox-button">Zoom</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">View</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">Quần áo 4</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                  <div class="sticker sticker-sale"></div>
                </div>
              ...
              <div>
                <div class="product-item">
                  ...
                  <h3><a href="shop-item.html">Quần áo 6</a></h3>
                  <div class="pi-price">$29.00</div>
                  <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                </div>
              </div>
              ...
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    <img src="{{ asset('/pages/img/index-sliders/sl1.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                  </div>
                  <div class="item">
                    <img src="{{ asset('/pages/img/index-sliders/sl2.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                  </div>
                  <div class="item">
                    <img src="{{ asset('/pages/img/index-sliders/sl3.jpg')}}" class="img-responsive" alt="Berry Lace Dress">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 padding-top-10">
            2024 © ThanhVu. ALL Rights Reserved.
          </div>
          <!-- END COPYRIGHT -->
          <!-- BEGIN PAYMENTS -->
          ...
          <div class="col-md-4 col-sm-4 text-right">
            <p class="powered">Powered by: <a href="http://www.keenthemes.com/">Thanh Vu</a></p>
          </div>
          <!-- END POWERED -->
        </div>
      </div>
