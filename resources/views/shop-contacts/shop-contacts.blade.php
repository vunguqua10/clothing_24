        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-3">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              <li class="list-group-item clearfix"><a href="javascript:;"><i class="fa fa-angle-right"></i> Đăng nhập/Đăng kí</a></li>
              <li class="list-group-item clearfix"><a href="javascript:;"><i class="fa fa-angle-right"></i> Đặt lại mật khẩu</a></li>
              <li class="list-group-item clearfix"><a href="javascript:;"><i class="fa fa-angle-right"></i> My account</a></li>
              <li class="list-group-item clearfix"><a href="javascript:;"><i class="fa fa-angle-right"></i> Địa chỉ</a></li>
              <li class="list-group-item clearfix"><a href="javascript:;"><i class="fa fa-angle-right"></i> Yêu thích</a></li>
            </ul>

            <h2>Liên hệ chúng tôi</h2>
            <address>
                169/2 Đường số 5,Phường 15 ,Quận Gò Vấp,TP.Hồ Chí Minh.
                <br>
              <abbr title="Phone">P:</abbr> 0903393159<br>
            </address>
            <address>
