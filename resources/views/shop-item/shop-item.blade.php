              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="{{ asset('/pages/img/products/model7.jpg')}}" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="{{ asset('/pages/img/products/model7.jpg')}}">
                  </div>
                  <div class="product-other-images">
                    <a href="{{ asset('/pages/img/products/model3.jpg')}}" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{ asset('/pages/img/products/model3.jpg')}}"></a>
                    <a href="{{ asset('/pages/img/products/model4.jpg')}}" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{ asset('/pages/img/products/model4.jpg')}}"></a>
                    <a href="{{ asset('/pages/img/products/model5.jpg')}}" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="{{ asset('/pages/img/products/model5.jpg')}}"></a>
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
